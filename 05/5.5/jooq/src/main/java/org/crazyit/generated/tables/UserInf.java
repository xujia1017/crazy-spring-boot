...
public class UserInf extends TableImpl<UserInfRecord> {
     ...
     */
    public final TableField<UserInfRecord, Integer> USER_ID =
            createField(DSL.name("user_id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>springboot.user_inf.name</code>.
     */
    public final TableField<UserInfRecord, String> NAME =
            createField(DSL.name("name"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>springboot.user_inf.password</code>.
     */
    public final TableField<UserInfRecord, String> PASSWORD =
            createField(DSL.name("password"), SQLDataType.VARCHAR(255), this, "");
